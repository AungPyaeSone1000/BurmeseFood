...
const FeaturedProducts = ({ featuredProducts }) => {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (window.innerWidth < 1024) setItemPerPage(2);
      if (window.innerWidth < 1280) setItemPerPage(3);
  ...
  return (
    <div className="py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-5xl sm:text-6xl font-bold text-emerald-600 mb-4">
          Featured
        </h2>
